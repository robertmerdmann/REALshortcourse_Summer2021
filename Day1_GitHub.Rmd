...
## Setup your computer  
Because we will be working remotely, it is very important that you spend time making sure that your computer is set-up and ready to go. You should have already downloaded the latest versions R and R studio, and we advise doing the same thing for Zoom. On occasion, all that's blocking something from working is an update, so keep this tyipe on your back pocket.
...
## Your GitHub account  
Since we will use GitHub for assignments, you need to have an account and make a repository. If you followed the [setup instructions](https://jmledford3115.github.io/datascibiol/setup.html) above then you should be all set. 


## Make Your Own Repository  
1. Go to [github.com](www.github.com) and login.  
2. Create a new repository.  
3. Under repository name, use the title `REALRNC2021_your first initial and lastname`. Mine looks like this: REALRNC2021_EWeigel
...
7. Add "choosyfemale" as a collaborator. Repeat for others you'd like to have access.  
...
Copy the `Day1` folder from the class repository and paste it into your personal repository. By doing this, you have created your own copies of lab materials for Day1.    
