...
## Setup your computer  
Because we will be working remotely, it is very important that you spend time making sure that your computer is set-up and ready to go. You should have already downloaded the latest versions R and R studio, and we advise doing the same thing for Zoom. On occasion, all that's blocking something from working is an update, so keep this tip in your back pocket.
